    ...
    var KTUsersList = function () {
        ...
        var handleDeleteRows = () => {
            ...
            deleteButtons.forEach(d => {
                ...
                d.addEventListener('click', function (e) {
                    ...
                    Confirm("Delete user", "warning", "Are you sure you want to delete " + search_col + " user ?", true, "",
                        function () {
                            $.ajax({
                                type: 'POST',
                                url: href,
        ...
        var initToggleToolbar = () => {
            ...
            deleteSelected.addEventListener('click', function () {
                ...
                Confirm("Delete users", "warning", "Are you sure you want to delete selected users?", true, "",
                    function () {
                        // Remove all selected customers
                        checkboxes.forEach(c => {
                            if (c.checked) {
                                var href = $(c.closest('tbody tr')).find('td a[data-kt-users-table-filter="delete_row"]').attr("href")
                                var id = $(c.closest('tbody tr')).find('td a[data-kt-users-table-filter="delete_row"]').data("id")
                                $.ajax({
                                    type: 'POST',
                                    url: href,
                                    data: { "id": id },
                    ...
                    function () {
                        Confirm("Delete canceled", "error", "Selected users was not deleted.", false, "Ok, got it!", function () { }, function () { })
                    })
